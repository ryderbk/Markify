                ...
                <div className="col-span-2 sm:col-span-1 relative group space-y-1.5">
                  ...
                  <Select value={paper.type} onValueChange={(v) => updatePaper(paper.id, 'type', v)}>
                    ...
                    <SelectContent 
                      ...
                      sideOffset={8}
                    >
                      <SelectItem value="theory" className="text-base font-medium py-2 px-4 rounded-lg cursor-pointer hover:bg-primary/10 data-[state=checked]:bg-primary/10 data-[state=checked]:text-primary focus:outline-none focus:bg-primary/10 focus:text-primary transition-colors duration-200">Theory (Max 40)</SelectItem>
                      <SelectItem value="integrated" className="text-base font-medium py-2 px-4 rounded-lg cursor-pointer hover:bg-primary/10 data-[state=checked]:bg-primary/10 data-[state=checked]:text-primary focus:outline-none focus:bg-primary/10 focus:text-primary transition-colors duration-200">Integrated (Max 50)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
